                ...
                <div class="modal fade " id="example" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-floating">
                                <input type="text" name="título"class="form-control"  onChange={this.handleChange} value={this.state.form.título} />
                                <label for="floatingPassword">Titulo</label>
                            </div>
                            <br/>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="géneros"  onChange={this.handleChange} value={this.state.form.géneros} />
                                <label for="floatingInput">Genero</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="lanzamiento"  onChange={this.handleChange} value={this.state.form.lanzamiento} />
